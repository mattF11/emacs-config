;;PER IMPORTARE progetti java in eclipse senza errori in eclipse(danno avviso ma funzionano quando compili)
 (defun JavaProjectEclipse ()
  (interactive)
  (let* ((name (read-string "Nome progetto: "))
         ...
         (template "~/.emacs.d/templates/eclipse-java-project"))
